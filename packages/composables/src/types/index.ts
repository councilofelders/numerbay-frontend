...
import {ProductVariant} from '@numerbay/numerbay-api';
...
export type User = {
  ...
  default_receiving_wallet_address?: string;
  // eslint-disable-next-line camelcase
...
export interface UserGetters<USER> {
    ...
    getDefaultReceivingWalletAddress: (customer: USER) => string;
...
export interface ProductGetters<PRODUCT, PRODUCT_FILTER> {
    ...
    getOptionFormattedDescription: (option: any, category: any) => string;
