...
import { Cart, LineItem } from '@numerbay/numerbay-api/src/types';
...
export const getCartItems = (cart: Cart): LineItem[] => [
  {
    ...
    sku: 'black-jacket',
    images: [
      'https://numerai-public-images.s3.amazonaws.com/profile_images/weekend-Qzl7KmFRcrH6.jpg'
    ],
    price: {
      original: 12.34,
      current: 10.00
...
// eslint-disable-next-line @typescript-eslint/no-unused-vars
export const getCartItemImage = (product: any): string => product?.images[0] || 'https://numerai-public-images.s3.amazonaws.com/profile_images/weekend-Qzl7KmFRcrH6.jpg';
